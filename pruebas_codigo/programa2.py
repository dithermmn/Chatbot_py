#--------------------------------------
# Programa VERSION 2 (edit del original)
#--------------------------------------

from flask import Flask, request, jsonify, render_template
from basedatos_programa2 import db, Log, init_db, agregar_mensajes_log, marcar_menu_enviado, ya_envio_menu, reiniciar_estado
from pruebas_codigo.mensaje_programa2 import enviar_menu, enviar_opcion, enviar_texto
import json
